...
exports.showAlert4 = exports.showAlert3 = exports.showAlert2 = exports.showAlert1 = exports.showAlert = exports.hideAlert = void 0;
...
var showAlert = function showAlert(type, msg) {
  hideAlert();
  var markup = "<div class=\"alert alert-dismissible alert-".concat(type, "\" role=\"alert\">").concat(msg, "                      \n                      <button type=\"button\" class=\"close\" data-dismiss=\"alert\" aria-label=\"Close\">\n                      <span aria-hidden=\"true\">&times;</span>\n                  </button></div>");
  document.querySelector('.alert-insert').insertAdjacentHTML('afterbegin', markup);
  window.setTimeout(hideAlert, 5000);
};

exports.showAlert = showAlert;

var showAlert1 = function showAlert1(type, msg) {
  hideAlert();
  var markup = "<div class=\"alert alert-dismissible alert-".concat(type, "\" role=\"alert\">").concat(msg, "                      \n                      <button type=\"button\" class=\"close\" data-dismiss=\"alert\" aria-label=\"Close\">\n                      <span aria-hidden=\"true\">&times;</span>\n                  </button></div>");
  document.querySelector('.alert-insert1').insertAdjacentHTML('afterbegin', markup);
  window.setTimeout(hideAlert, 5000);
};

exports.showAlert1 = showAlert1;

var showAlert2 = function showAlert2(type, msg) {
  hideAlert();
  var markup = "<div class=\"alert alert-dismissible alert-".concat(type, "\" role=\"alert\">").concat(msg, "                      \n                      <button type=\"button\" class=\"close\" data-dismiss=\"alert\" aria-label=\"Close\">\n                      <span aria-hidden=\"true\">&times;</span>\n                  </button></div>");
  document.querySelector('.alert-insert2').insertAdjacentHTML('afterbegin', markup);
  window.setTimeout(hideAlert, 5000);
};

exports.showAlert2 = showAlert2;

var showAlert3 = function showAlert3(type, msg) {
  hideAlert();
  var markup = "<div class=\"alert alert-dismissible alert-".concat(type, "\" role=\"alert\">").concat(msg, "                      \n                      <button type=\"button\" class=\"close\" data-dismiss=\"alert\" aria-label=\"Close\">\n                      <span aria-hidden=\"true\">&times;</span>\n                  </button></div>");
  document.querySelector('.alert-insert3').insertAdjacentHTML('afterbegin', markup);
  window.setTimeout(hideAlert, 5000);
};

exports.showAlert3 = showAlert3;

var showAlert4 = function showAlert4(type, msg) {
  hideAlert();
  var markup = "<div class=\"alert alert-dismissible alert-".concat(type, "\" role=\"alert\">").concat(msg, "                      \n                      <button type=\"button\" class=\"close\" data-dismiss=\"alert\" aria-label=\"Close\">\n                      <span aria-hidden=\"true\">&times;</span>\n                  </button></div>");
  document.querySelector('.alert-insert4').insertAdjacentHTML('afterbegin', markup);
  window.setTimeout(hideAlert, 5000);
};

exports.showAlert4 = showAlert4;
...
exports.logout = exports.signup = exports.login = exports.updateImage = exports.deleteUser = exports.updateUser = exports.uploadSTLFiles = exports.updatePrinter = void 0;
...
function () {
  ...
  /*#__PURE__*/
  regeneratorRuntime.mark(function _callee(printer) {
    var res;
        ...
        switch (_context.prev = _context.next) {
          ...
          case 3:
            ...
            if (res.data.status === 'success') {
              (0, _alert.showAlert)('success', 'Printer selected successfully');
...
function () {
      ...
      while (1) {
        switch (_context2.prev = _context2.next) {
          ...
          case 3:
            ...
            if (res.data.status === 'success') {
              (0, _alert.showAlert4)('success', 'STL File Uploaded successfully');
              window.setTimeout(function () {
                location.reload();
              }, 2000);
            }
          ...
          case 7:
            ...
            (0, _alert.showAlert4)('danger', _context2.t0.response.data.message);
  ...
  return function uploadSTLFiles(_x2) {
    return _ref2.apply(this, arguments);
  };
}();

exports.uploadSTLFiles = uploadSTLFiles;
...
function () {
  ...
  /*#__PURE__*/
  regeneratorRuntime.mark(function _callee3(printStatus, userID) {
    var res;
      ...
      while (1) {
        switch (_context3.prev = _context3.next) {
          ...
          case 3:
            ...
            if (res.data.status === 'success') {
              (0, _alert.showAlert2)('success', 'Print Status updated successfully');
              window.setTimeout(function () {
                location.reload();
              }, 2000);
            }
          ...
          case 7:
            ...
            (0, _alert.showAlert2)('danger', _context3.t0.response.data.message);
      ...
      while (1) {
        switch (_context4.prev = _context4.next) {
          ...
          case 3:
            ...
            if (res.status === 204) {
              (0, _alert.showAlert3)('success', 'User deleted successfully');
              window.setTimeout(function () {
                location.reload();
              }, 2000);
            }
          ...
          case 7:
            ...
            (0, _alert.showAlert3)('danger', _context4.t0.response.data.message);
...
function () {
  ...
  /*#__PURE__*/
  regeneratorRuntime.mark(function _callee5(userID, data, image) {
    var res;
      ...
      while (1) {
        switch (_context5.prev = _context5.next) {
          ...
          case 8:
            ...
            (0, _alert.showAlert)('danger', _context5.t0.response.data.message);
  ...
  return function updateImage(_x6, _x7, _x8) {
...
function () {
  ...
  /*#__PURE__*/
  regeneratorRuntime.mark(function _callee6(email, password) {
    var res;
      ...
      while (1) {
        switch (_context6.prev = _context6.next) {
          ...
          case 7:
            ...
            (0, _alert.showAlert)('danger', _context6.t0.response.data.message);
...
function () {
  ...
  /*#__PURE__*/
  regeneratorRuntime.mark(function _callee7(name, email, password, passwordConfirm) {
    var res;
      ...
      while (1) {
        switch (_context7.prev = _context7.next) {
          ...
          case 7:
            ...
            (0, _alert.showAlert)('danger', _context7.t0.response.data.message);
  ...
  return function signup(_x11, _x12, _x13, _x14) {
...
var uploadSTLForm = document.querySelector('.upload-stl-file-form');
var statusForm = document.querySelector('.set-status-form');
var deleteForm = document.querySelector('.delete-form');
var round1Form = document.querySelector('.round-1-form');
var round2Form = document.querySelector('.round-2-form');
...
if (printerForm) {
  printerForm.addEventListener('submit', function (e) {
    ...
    (0, _updateSettings.updatePrinter)(printer);
  });
}

if (uploadSTLForm) {
  uploadSTLForm.addEventListener('submit', function (e) {
    e.preventDefault();
    var form = new FormData();

    if (document.getElementById('submission1')) {
      form.append('submission1', document.getElementById('submission1').files[0]);
    }

    if (document.getElementById('submission2')) {
      form.append('submission2', document.getElementById('submission2').files[0]);
      form.append('printStatus', 'received');
    }

    (0, _updateSettings.uploadSTLFiles)(form);
  });
}
...
if (statusForm) {
  statusForm.addEventListener('submit', function (e) {
    e.preventDefault();
    var printStatus = document.getElementById('printStatusSelect').value;
    var userID = document.querySelector('.active-edit').dataset.id;
    (0, _updateSettings.updateUser)(printStatus, userID);
  });
}
...
if (deleteForm) {
  deleteForm.addEventListener('submit', function (e) {
    e.preventDefault();
    var userID = document.querySelector('.active-delete').dataset.id;
    (0, _updateSettings.deleteUser)(userID);
  });
}

if (round1Form) {
  round1Form.addEventListener('submit', function (e) {
    e.preventDefault();
    var userID = document.querySelector('.active-edit').dataset.id;
    var form = new FormData();
    ...
    (0, _updateSettings.updateImage)(userID, form, 'image1');
  });
}

if (round2Form) {
  round2Form.addEventListener('submit', function (e) {
    e.preventDefault();
    var userID = document.querySelector('.active-edit').dataset.id;
    var form = new FormData();
    ...
    (0, _updateSettings.updateImage)(userID, form, 'image2');
  });
}
...
if (loginForm) {
  loginForm.addEventListener('submit', function (e) {
    ...
    (0, _updateSettings.login)(email, password);
  });
}
